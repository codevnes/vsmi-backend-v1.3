#!/usr/bin/env node
/**
 * Script to import FScores from Excel file
 * Usage: node import-fscores.js [filePath]
 * 
  ...
  try {
    ...
    for (const row of data) {
      try {
        ...
        // Extract FScore data from row with updated column mappings based on the error log
        const fscoreData = {
        ...
        if (existingFScore && existingFScore.length > 0) {
