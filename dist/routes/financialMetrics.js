...
router.get('/stock/:symbol', financialMetrics_controller_1.getFinancialMetricsBySymbol);
router.get('/stock/:symbol/year/:year/quarter/:quarter', financialMetrics_controller_1.getFinancialMetricsBySymbolYearQuarter);
router.get('/stock/:symbol/year/:year', financialMetrics_controller_1.getFinancialMetricsBySymbolYearQuarter);
