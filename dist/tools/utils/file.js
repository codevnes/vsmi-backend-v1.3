...
var unlinkAsync = (0, util_1.promisify)(fs_1.default.unlink);
/**
...
var generateFileName = function (originalname) {
    ...
    var randomString = crypto_1.default.randomBytes(8).toString('hex');
    var ext = path_1.default.extname(originalname);
    var fileName = "".concat(timestamp, "-").concat(randomString).concat(ext);
    return fileName;
};
...
var isImage = function (mimetype) {
    var allowedMimeTypes = ['image/jpeg', 'image/png', 'image/gif', 'image/webp', 'image/svg+xml'];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, unlinkAsync(filePath)];
            case 1:
                _a.sent();
                _a.label = 2;
 ...
 */
var ensureDirectoryExists = function (dirPath) {
